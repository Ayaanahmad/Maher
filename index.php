...
<?php include "header.php"; ?>	
		...
		<ul class="slides-container">
			<li class="text-left">
				...
				<div class="container">
					<div class="row">
						<div class="col-md-12">
							<h1 class="m-b-20"><strong>Welcome To <br> Maher Restaurant</strong></h1>
				...
				<div class="container">
					<div class="row">
						<div class="col-md-12">
							...
							<p class="m-b-40">Maher Restaurant is serving Authentic Food. Restaurant's <br> 
			...
			<li class="text-left">
				...
				<div class="container">
					<div class="row">
						<div class="col-md-12">
							<h1 class="m-b-20"><strong>Welcome To <br> Yummyfood with Maher</strong></h1>
	...
	<div class="about-section-box">
		<div class="container">
			<div class="row">
				<div class="col-lg-11 col-md-11 col-sm-12 text-center">0
						<h1>Welcome To <span>Maher Restaurant</span></h1>
						<h4>Little Story</h4>
						<p>Restaurants in Patna, Champaran restaurants, Bhopal restaurants, Best Bhopal restaurants, Nalanda restaurants, Danapur Restaurants, Bihari near me, Bihari Restaurants in Patna, Bihari Restaurants in Bhopal.</p>
						<p>Quick Bites in Patna, Quick Bites near me, Quick Bites in Nalanda, Quick Bites in Bhopal, Quick bites in Champaran, near me, in East Patna, in Bhopal, near me, in Bhopal, New Year Parties in Patna, Christmas' Special in Patna.</p>
						<a class="btn btn-lg btn-circle btn-outline-new-white" href="#">Contact Us</a>
					</div>
				</div>
				<div class="col-lg-11 col-md-11 col-sm-12">
					<img src="images/images.jpg"  width="300%" height="300%" class="img-fluid">
				</div>
			</div>
		</div>
	</div>
		...
		<div class="container">
			<div class="row">
				<div class="col-md-8 ml-auto mr-auto text-center">
					<p class="lead ">
						" If you love the food of Maher, then compliment the work of our chefs "
					</p>
					<span class="lead">Maher Restaurant</span>
				</div>
			</div>
		</div>
	</div>
			...
			<div class="row">
				<div class="col-lg-12">
					<div class="heading-title text-center">
						<h2>Special Menu</h2>
						<p>Enjoy your favourite dishes</p>
					</div>
				</div>
			</div>
			...
			<div class="row inner-menu-box">
				<div class="col-3">
					<div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
						...
						<a class="nav-link" id="v-pills-profile-tab" data-toggle="pill" href="#v-pills-profile" role="tab" aria-controls="v-pills-profile" aria-selected="false">Gravy</a>
						<a class="nav-link" id="v-pills-messages-tab" data-toggle="pill" href="#v-pills-messages" role="tab" aria-controls="v-pills-messages" aria-selected="false">Bihari</</a>
				...
				<div class="col-9">
					<div class="tab-content" id="v-pills-tabContent">
						...
						<div class="tab-pane fade" id="v-pills-profile" role="tabpanel" aria-labelledby="v-pills-profile-tab">
							...
							<?php include "connect.php";
								$s = mysqli_query($con,"select * from menu where category='Gravy'");
								while($r = mysqli_fetch_array($s))
								{	
								?>
						...
						<div class="tab-pane fade" id="v-pills-messages" role="tabpanel" aria-labelledby="v-pills-messages-tab">
							<div class="row">
								...
								<?php include "connect.php";
								$s = mysqli_query($con,"select * from menu where category='Bihari'");
								while($r = mysqli_fetch_array($s))
								{	
								?>
								<div class="col-lg-4 col-md-6 special-grid drinks">
						...
						<div class="tab-pane fade" id="v-pills-settings" role="tabpanel" aria-labelledby="v-pills-settings-tab">
							<div class="row">
                             <?php include "connect.php";
								$s = mysqli_query($con,"select * from menu where category='Rice'");
								while($r = mysqli_fetch_array($s))
								{	
								?>
								<div class="col-lg-4 col-md-6 special-grid drinks">
		...
		<div class="container">
			<div class="row">
				<div class="col-lg-12">
					<div class="heading-title text-center">
						<h2>Gallery</h2>
						<p>Delicious food Pictures for Maher Restaurant are Listed Here </p>
					</div>
				</div>
			</div>
